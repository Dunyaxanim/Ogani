                               ...
                               @foreach (config('translatable.locales') as $key => $lang)
                                <div class="tab-pane fade {{ $loop->first ? 'active show' : '' }}"
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">{{ $lang }} {{ __("Title") }}</label>
                                         ...
                                         <div class=" pad">
                                          ...
                                          <div class="form-group">
                                            <label for="exampleInputEmail1">{{ $lang }} {{ __("Content") }}</label>
                                            <input type="text"
                                                class="form-control @error('content') is-invalid @enderror"
                                                id="exampleInputEmail1" placeholder="Enter content"
                                                value="{{old("$lang.content", isset($model) ? $model->translateOrDefault($lang)->content : '' )}}"
                                                name="{{ $lang }}[content]">
                                            @error('content')
                                                <span class="text-danger" style="font-size: 14x">{{ $message }}</span>
                                            @enderror
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="file" class="form-control @error('img') is-invalid @enderror"
                                            id="exampleInputEmail1" placeholder="Enter img"
                                            name="img">
                                        @error('img')
                                            <span class="text-danger" style="font-size: 14x">{{ $message }}</span>
                                        @enderror
                                      ...
                                      <div class="form-group">
                                        <label for="exampleInputEmail1">{{ __("Minor image") }}</label>
                                        <input type="file" class="form-control @error('minor_img') is-invalid @enderror"
                                            id="exampleInputEmail1" placeholder="Enter minor image"
                                            name="minor_img">
                                        @error('minor_img')
                                            <span class="text-danger" style="font-size: 14x">{{ $message }}</span>
                                        @enderror
