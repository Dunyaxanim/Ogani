        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
             <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="{{ route($routeName.'create-form') }}">{{ __("Create new") }}</a></li>
            </ol>
          </div>
        </div>
      </div>
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                  @foreach($model as $key => $data)
                    <tr>
                     <td><img style="height: 70px; width:70px; margin:auto;" src="{{Storage::url($data->img)}}" alt=""></td>
                     <td><img style="height: 70px; width:70px; margin:auto;" src="{{Storage::url($data->minor_img)}}" alt=""></td>
                     <td>{{$data->title}}</td>
