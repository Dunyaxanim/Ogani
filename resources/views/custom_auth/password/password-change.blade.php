        ...
        <form action="{{ route('forgot-password-post') }}" method="POST">
            ...
            <div style="padding:20px">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control my-2" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter password" name="password"> <br>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Password confirmation</label><br>
                    <input type="password" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter password confirmation" name="password_confirmation"> <br>
                </div>
